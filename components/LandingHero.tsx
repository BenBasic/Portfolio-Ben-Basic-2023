...
const LandingHero: React.FC = () => {
    return (
        <div className='w-full max-w-xl px-6 py-6 mx-auto text-center mobiletiny:py-10 mobilemd:px-10'>
            ...
            <h1 className="text-5xl mobiletiny:text-6xl 2xl:text-7xl text-retrolight font-cursive drop-shadow-[3px_3px_0px_rgb(236,114,101)] mobiletiny:drop-shadow-[4px_4px_0px_rgb(236,114,101)]">
                Ben Basic
            </h1>

            <p className="my-4 text-sm mobiletiny:text-base mobilesm:text-lg 2xl:text-2xl text-newwhite font-heading">
